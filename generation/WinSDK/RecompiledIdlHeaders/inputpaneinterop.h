/*** Autogenerated by WIDL 5.0 from ./um/inputpaneinterop.idl - Do not edit ***/
...
/*** IInputPaneInterop methods ***/
#define IInputPaneInterop_GetForWindow(This,appWindow,riid,inputPane) (This)->lpVtbl->GetForWindow(This,appWindow,riid,inputPane)
#else
/*** IUnknown methods ***/
static FORCEINLINE HRESULT IInputPaneInterop_QueryInterface(IInputPaneInterop* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static FORCEINLINE ULONG IInputPaneInterop_AddRef(IInputPaneInterop* This) {
    return This->lpVtbl->AddRef(This);
}
static FORCEINLINE ULONG IInputPaneInterop_Release(IInputPaneInterop* This) {
    return This->lpVtbl->Release(This);
}
/*** IInspectable methods ***/
static FORCEINLINE HRESULT IInputPaneInterop_GetIids(IInputPaneInterop* This,ULONG *iidCount,IID **iids) {
    return This->lpVtbl->GetIids(This,iidCount,iids);
}
static FORCEINLINE HRESULT IInputPaneInterop_GetRuntimeClassName(IInputPaneInterop* This,HSTRING *className) {
    return This->lpVtbl->GetRuntimeClassName(This,className);
}
static FORCEINLINE HRESULT IInputPaneInterop_GetTrustLevel(IInputPaneInterop* This,TrustLevel *trustLevel) {
    return This->lpVtbl->GetTrustLevel(This,trustLevel);
}
/*** IInputPaneInterop methods ***/
static FORCEINLINE HRESULT IInputPaneInterop_GetForWindow(IInputPaneInterop* This,HWND appWindow,REFIID riid,void **inputPane) {
    return This->lpVtbl->GetForWindow(This,appWindow,riid,inputPane);
}
#endif
#endif
