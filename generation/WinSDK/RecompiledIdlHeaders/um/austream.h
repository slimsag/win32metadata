/*** Autogenerated by WIDL 7.0-rc1 from ./austream.idl - Do not edit ***/
...
static FORCEINLINE HRESULT IAudioStreamSample_Update(IAudioStreamSample* This,DWORD dwFlags,HANDLE hEvent,PAPCFUNC pfnAPC,DWORD_PTR dwAPCData) {
