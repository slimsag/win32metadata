/*** Autogenerated by WIDL 7.0-rc1 from ./bits1_5.idl - Do not edit ***/
...
typedef struct __WIDL_bits1_5_generated_name_0000000C {
    LPWSTR UserName;
    LPWSTR Password;
} BG_BASIC_CREDENTIALS;
typedef BG_BASIC_CREDENTIALS *PBG_BASIC_CREDENTIALS;
typedef union __WIDL_bits1_5_generated_name_0000000D {
    BG_BASIC_CREDENTIALS Basic;
} BG_AUTH_CREDENTIALS_UNION;
typedef struct __WIDL_bits1_5_generated_name_0000000E {
...
/*** IBackgroundCopyJob2 methods ***/
static FORCEINLINE HRESULT IBackgroundCopyJob2_SetNotifyCmdLine(IBackgroundCopyJob2* This,LPCWSTR Program,LPCWSTR Parameters) {
    return This->lpVtbl->SetNotifyCmdLine(This,Program,Parameters);
}
static FORCEINLINE HRESULT IBackgroundCopyJob2_GetNotifyCmdLine(IBackgroundCopyJob2* This,LPWSTR *pProgram,LPWSTR *pParameters) {
    return This->lpVtbl->GetNotifyCmdLine(This,pProgram,pParameters);
}
static FORCEINLINE HRESULT IBackgroundCopyJob2_GetReplyProgress(IBackgroundCopyJob2* This,BG_JOB_REPLY_PROGRESS *pProgress) {
    return This->lpVtbl->GetReplyProgress(This,pProgress);
}
static FORCEINLINE HRESULT IBackgroundCopyJob2_GetReplyData(IBackgroundCopyJob2* This,byte **ppBuffer,UINT64 *pLength) {
    return This->lpVtbl->GetReplyData(This,ppBuffer,pLength);
}
static FORCEINLINE HRESULT IBackgroundCopyJob2_SetReplyFileName(IBackgroundCopyJob2* This,LPCWSTR ReplyFileName) {
    return This->lpVtbl->SetReplyFileName(This,ReplyFileName);
}
static FORCEINLINE HRESULT IBackgroundCopyJob2_GetReplyFileName(IBackgroundCopyJob2* This,LPWSTR *pReplyFileName) {
    return This->lpVtbl->GetReplyFileName(This,pReplyFileName);
}
static FORCEINLINE HRESULT IBackgroundCopyJob2_SetCredentials(IBackgroundCopyJob2* This,BG_AUTH_CREDENTIALS *credentials) {
