/*** Autogenerated by WIDL 7.0-rc1 from ./oaidl.idl - Do not edit ***/
...
DEFINE_GUID(IID_ITypeLibRegistrationReader, 0xed6a8a2a, 0xb160, 0x4e77, 0x8f,0x73, 0xaa,0x74,0x35,0xcd,0x5c,0x27);
#if defined(__cplusplus) && !defined(CINTERFACE)
...
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(ITypeLibRegistrationReader, 0xed6a8a2a, 0xb160, 0x4e77, 0x8f,0x73, 0xaa,0x74,0x35,0xcd,0x5c,0x27)
#endif
#else
...
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
#define ITypeLibRegistrationReader_QueryInterface(This,riid,ppvObject) (This)->lpVtbl->QueryInterface(This,riid,ppvObject)
#define ITypeLibRegistrationReader_AddRef(This) (This)->lpVtbl->AddRef(This)
#define ITypeLibRegistrationReader_Release(This) (This)->lpVtbl->Release(This)
/*** ITypeLibRegistrationReader methods ***/
#define ITypeLibRegistrationReader_EnumTypeLibRegistrations(This,ppEnumUnknown) (This)->lpVtbl->EnumTypeLibRegistrations(This,ppEnumUnknown)
#else
/*** IUnknown methods ***/
static FORCEINLINE HRESULT ITypeLibRegistrationReader_QueryInterface(ITypeLibRegistrationReader* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static FORCEINLINE ULONG ITypeLibRegistrationReader_AddRef(ITypeLibRegistrationReader* This) {
    return This->lpVtbl->AddRef(This);
}
static FORCEINLINE ULONG ITypeLibRegistrationReader_Release(ITypeLibRegistrationReader* This) {
    return This->lpVtbl->Release(This);
}
/*** ITypeLibRegistrationReader methods ***/
static FORCEINLINE HRESULT ITypeLibRegistrationReader_EnumTypeLibRegistrations(ITypeLibRegistrationReader* This,IEnumUnknown **ppEnumUnknown) {
    return This->lpVtbl->EnumTypeLibRegistrations(This,ppEnumUnknown);
}
#endif
#endif
...
DEFINE_GUID(IID_ITypeLibRegistration, 0x76a3e735, 0x02df, 0x4a12, 0x98,0xeb, 0x04,0x3a,0xd3,0x60,0x0a,0xf3);
#if defined(__cplusplus) && !defined(CINTERFACE)
...
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(ITypeLibRegistration, 0x76a3e735, 0x02df, 0x4a12, 0x98,0xeb, 0x04,0x3a,0xd3,0x60,0x0a,0xf3)
#endif
#else
...
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
#define ITypeLibRegistration_QueryInterface(This,riid,ppvObject) (This)->lpVtbl->QueryInterface(This,riid,ppvObject)
#define ITypeLibRegistration_AddRef(This) (This)->lpVtbl->AddRef(This)
#define ITypeLibRegistration_Release(This) (This)->lpVtbl->Release(This)
/*** ITypeLibRegistration methods ***/
#define ITypeLibRegistration_GetGuid(This,pGuid) (This)->lpVtbl->GetGuid(This,pGuid)
#define ITypeLibRegistration_GetVersion(This,pVersion) (This)->lpVtbl->GetVersion(This,pVersion)
#define ITypeLibRegistration_GetLcid(This,pLcid) (This)->lpVtbl->GetLcid(This,pLcid)
#define ITypeLibRegistration_GetWin32Path(This,pWin32Path) (This)->lpVtbl->GetWin32Path(This,pWin32Path)
#define ITypeLibRegistration_GetWin64Path(This,pWin64Path) (This)->lpVtbl->GetWin64Path(This,pWin64Path)
#define ITypeLibRegistration_GetDisplayName(This,pDisplayName) (This)->lpVtbl->GetDisplayName(This,pDisplayName)
#define ITypeLibRegistration_GetFlags(This,pFlags) (This)->lpVtbl->GetFlags(This,pFlags)
#define ITypeLibRegistration_GetHelpDir(This,pHelpDir) (This)->lpVtbl->GetHelpDir(This,pHelpDir)
#else
/*** IUnknown methods ***/
static FORCEINLINE HRESULT ITypeLibRegistration_QueryInterface(ITypeLibRegistration* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static FORCEINLINE ULONG ITypeLibRegistration_AddRef(ITypeLibRegistration* This) {
    return This->lpVtbl->AddRef(This);
}
static FORCEINLINE ULONG ITypeLibRegistration_Release(ITypeLibRegistration* This) {
    return This->lpVtbl->Release(This);
}
/*** ITypeLibRegistration methods ***/
static FORCEINLINE HRESULT ITypeLibRegistration_GetGuid(ITypeLibRegistration* This,GUID *pGuid) {
    return This->lpVtbl->GetGuid(This,pGuid);
}
static FORCEINLINE HRESULT ITypeLibRegistration_GetVersion(ITypeLibRegistration* This,BSTR *pVersion) {
    return This->lpVtbl->GetVersion(This,pVersion);
}
static FORCEINLINE HRESULT ITypeLibRegistration_GetLcid(ITypeLibRegistration* This,LCID *pLcid) {
    return This->lpVtbl->GetLcid(This,pLcid);
}
static FORCEINLINE HRESULT ITypeLibRegistration_GetWin32Path(ITypeLibRegistration* This,BSTR *pWin32Path) {
    return This->lpVtbl->GetWin32Path(This,pWin32Path);
}
static FORCEINLINE HRESULT ITypeLibRegistration_GetWin64Path(ITypeLibRegistration* This,BSTR *pWin64Path) {
    return This->lpVtbl->GetWin64Path(This,pWin64Path);
}
static FORCEINLINE HRESULT ITypeLibRegistration_GetDisplayName(ITypeLibRegistration* This,BSTR *pDisplayName) {
    return This->lpVtbl->GetDisplayName(This,pDisplayName);
}
static FORCEINLINE HRESULT ITypeLibRegistration_GetFlags(ITypeLibRegistration* This,DWORD *pFlags) {
    return This->lpVtbl->GetFlags(This,pFlags);
}
static FORCEINLINE HRESULT ITypeLibRegistration_GetHelpDir(ITypeLibRegistration* This,BSTR *pHelpDir) {
    return This->lpVtbl->GetHelpDir(This,pHelpDir);
}
#endif
#endif
