/*** Autogenerated by WIDL 7.0-rc1 from ./mstask.idl - Do not edit ***/
...
static FORCEINLINE HRESULT IScheduledWorkItem_GetTriggerCount(IScheduledWorkItem* This,WORD *pwCount) {
    return This->lpVtbl->GetTriggerCount(This,pwCount);
}
...
static FORCEINLINE HRESULT IScheduledWorkItem_SetWorkItemData(IScheduledWorkItem* This,WORD cbData,BYTE rgbData[]) {
    return This->lpVtbl->SetWorkItemData(This,cbData,rgbData);
}
static FORCEINLINE HRESULT IScheduledWorkItem_GetWorkItemData(IScheduledWorkItem* This,WORD *pcbData,BYTE **prgbData) {
    return This->lpVtbl->GetWorkItemData(This,pcbData,prgbData);
}
...
static FORCEINLINE HRESULT ITask_GetTriggerCount(ITask* This,WORD *pwCount) {
    return This->lpVtbl->GetTriggerCount(This,pwCount);
}
...
static FORCEINLINE HRESULT ITask_SetWorkItemData(ITask* This,WORD cbData,BYTE rgbData[]) {
    return This->lpVtbl->SetWorkItemData(This,cbData,rgbData);
}
static FORCEINLINE HRESULT ITask_GetWorkItemData(ITask* This,WORD *pcbData,BYTE **prgbData) {
    return This->lpVtbl->GetWorkItemData(This,pcbData,prgbData);
}
...
static FORCEINLINE HRESULT ITask_SetMaxRunTime(ITask* This,DWORD dwMaxRunTimeMS) {
    return This->lpVtbl->SetMaxRunTime(This,dwMaxRunTimeMS);
}
static FORCEINLINE HRESULT ITask_GetMaxRunTime(ITask* This,DWORD *pdwMaxRunTimeMS) {
    return This->lpVtbl->GetMaxRunTime(This,pdwMaxRunTimeMS);
}
#endif
#endif
...
static FORCEINLINE HRESULT ITaskScheduler_Enum(ITaskScheduler* This,IEnumWorkItems **ppEnumWorkItems) {
    return This->lpVtbl->Enum(This,ppEnumWorkItems);
}
