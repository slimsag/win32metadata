/*** Autogenerated by WIDL 7.0-rc1 from ./windows.ui.xaml.hosting.desktopwindowxamlsource.idl - Do not edit ***/
...
#else
/*** IUnknown methods ***/
static FORCEINLINE HRESULT IDesktopWindowXamlSourceNative_QueryInterface(IDesktopWindowXamlSourceNative* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static FORCEINLINE ULONG IDesktopWindowXamlSourceNative_AddRef(IDesktopWindowXamlSourceNative* This) {
    return This->lpVtbl->AddRef(This);
}
static FORCEINLINE ULONG IDesktopWindowXamlSourceNative_Release(IDesktopWindowXamlSourceNative* This) {
    return This->lpVtbl->Release(This);
}
/*** IDesktopWindowXamlSourceNative methods ***/
static FORCEINLINE HRESULT IDesktopWindowXamlSourceNative_AttachToWindow(IDesktopWindowXamlSourceNative* This,HWND parentWnd) {
    return This->lpVtbl->AttachToWindow(This,parentWnd);
}
static FORCEINLINE HRESULT IDesktopWindowXamlSourceNative_get_WindowHandle(IDesktopWindowXamlSourceNative* This,HWND *hWnd) {
...
/*** IDesktopWindowXamlSourceNative methods ***/
#define IDesktopWindowXamlSourceNative2_AttachToWindow(This,parentWnd) (This)->lpVtbl->AttachToWindow(This,parentWnd)
#define IDesktopWindowXamlSourceNative2_get_WindowHandle(This,hWnd) (This)->lpVtbl->get_WindowHandle(This,hWnd)
/*** IDesktopWindowXamlSourceNative2 methods ***/
...
#else
/*** IUnknown methods ***/
static FORCEINLINE HRESULT IDesktopWindowXamlSourceNative2_QueryInterface(IDesktopWindowXamlSourceNative2* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static FORCEINLINE ULONG IDesktopWindowXamlSourceNative2_AddRef(IDesktopWindowXamlSourceNative2* This) {
    return This->lpVtbl->AddRef(This);
}
static FORCEINLINE ULONG IDesktopWindowXamlSourceNative2_Release(IDesktopWindowXamlSourceNative2* This) {
    return This->lpVtbl->Release(This);
}
/*** IDesktopWindowXamlSourceNative methods ***/
static FORCEINLINE HRESULT IDesktopWindowXamlSourceNative2_AttachToWindow(IDesktopWindowXamlSourceNative2* This,HWND parentWnd) {
    return This->lpVtbl->AttachToWindow(This,parentWnd);
}
static FORCEINLINE HRESULT IDesktopWindowXamlSourceNative2_get_WindowHandle(IDesktopWindowXamlSourceNative2* This,HWND *hWnd) {
    return This->lpVtbl->get_WindowHandle(This,hWnd);
}
/*** IDesktopWindowXamlSourceNative2 methods ***/
static FORCEINLINE HRESULT IDesktopWindowXamlSourceNative2_PreTranslateMessage(IDesktopWindowXamlSourceNative2* This,const MSG *message,BOOL *result) {
