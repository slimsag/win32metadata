/*** Autogenerated by WIDL 7.0-rc1 from ./urlmon.idl - Do not edit ***/
...
#define FIEF_FLAG_RESERVED_0                0x8     
...
#define Uri_DISPLAY_NO_PUNYCODE               0x00000008    
...
DEFINE_GUID(IID_IZoneIdentifier2, 0xeb5e760c, 0x09ef, 0x45c0, 0xb5,0x10, 0x70,0x83,0x0c,0xe3,0x1e,0x6a);
#if defined(__cplusplus) && !defined(CINTERFACE)
...
IZoneIdentifier2 : public IZoneIdentifier
{
    ...
    virtual HRESULT STDMETHODCALLTYPE RemoveLastWriterPackageFamilyName(
        ) = 0;
    ...
    virtual HRESULT STDMETHODCALLTYPE RemoveAppZoneId(
        ) = 0;

};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IZoneIdentifier2, 0xeb5e760c, 0x09ef, 0x45c0, 0xb5,0x10, 0x70,0x83,0x0c,0xe3,0x1e,0x6a)
#endif
#else
...
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
#define IZoneIdentifier2_QueryInterface(This,riid,ppvObject) (This)->lpVtbl->QueryInterface(This,riid,ppvObject)
#define IZoneIdentifier2_AddRef(This) (This)->lpVtbl->AddRef(This)
#define IZoneIdentifier2_Release(This) (This)->lpVtbl->Release(This)
/*** IZoneIdentifier methods ***/
#define IZoneIdentifier2_GetId(This,pdwZone) (This)->lpVtbl->GetId(This,pdwZone)
#define IZoneIdentifier2_SetId(This,dwZone) (This)->lpVtbl->SetId(This,dwZone)
#define IZoneIdentifier2_Remove(This) (This)->lpVtbl->Remove(This)
/*** IZoneIdentifier2 methods ***/
#define IZoneIdentifier2_GetLastWriterPackageFamilyName(This,packageFamilyName) (This)->lpVtbl->GetLastWriterPackageFamilyName(This,packageFamilyName)
#define IZoneIdentifier2_SetLastWriterPackageFamilyName(This,packageFamilyName) (This)->lpVtbl->SetLastWriterPackageFamilyName(This,packageFamilyName)
#define IZoneIdentifier2_RemoveLastWriterPackageFamilyName(This) (This)->lpVtbl->RemoveLastWriterPackageFamilyName(This)
#define IZoneIdentifier2_GetAppZoneId(This,zone) (This)->lpVtbl->GetAppZoneId(This,zone)
#define IZoneIdentifier2_SetAppZoneId(This,zone) (This)->lpVtbl->SetAppZoneId(This,zone)
#define IZoneIdentifier2_RemoveAppZoneId(This) (This)->lpVtbl->RemoveAppZoneId(This)
#else
/*** IUnknown methods ***/
static FORCEINLINE HRESULT IZoneIdentifier2_QueryInterface(IZoneIdentifier2* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static FORCEINLINE ULONG IZoneIdentifier2_AddRef(IZoneIdentifier2* This) {
    return This->lpVtbl->AddRef(This);
}
static FORCEINLINE ULONG IZoneIdentifier2_Release(IZoneIdentifier2* This) {
    return This->lpVtbl->Release(This);
}
/*** IZoneIdentifier methods ***/
static FORCEINLINE HRESULT IZoneIdentifier2_GetId(IZoneIdentifier2* This,DWORD *pdwZone) {
    return This->lpVtbl->GetId(This,pdwZone);
}
static FORCEINLINE HRESULT IZoneIdentifier2_SetId(IZoneIdentifier2* This,DWORD dwZone) {
    return This->lpVtbl->SetId(This,dwZone);
}
static FORCEINLINE HRESULT IZoneIdentifier2_Remove(IZoneIdentifier2* This) {
    return This->lpVtbl->Remove(This);
}
/*** IZoneIdentifier2 methods ***/
static FORCEINLINE HRESULT IZoneIdentifier2_GetLastWriterPackageFamilyName(IZoneIdentifier2* This,LPWSTR *packageFamilyName) {
    return This->lpVtbl->GetLastWriterPackageFamilyName(This,packageFamilyName);
}
static FORCEINLINE HRESULT IZoneIdentifier2_SetLastWriterPackageFamilyName(IZoneIdentifier2* This,LPCWSTR packageFamilyName) {
    return This->lpVtbl->SetLastWriterPackageFamilyName(This,packageFamilyName);
}
static FORCEINLINE HRESULT IZoneIdentifier2_RemoveLastWriterPackageFamilyName(IZoneIdentifier2* This) {
    return This->lpVtbl->RemoveLastWriterPackageFamilyName(This);
}
static FORCEINLINE HRESULT IZoneIdentifier2_GetAppZoneId(IZoneIdentifier2* This,DWORD *zone) {
    return This->lpVtbl->GetAppZoneId(This,zone);
}
static FORCEINLINE HRESULT IZoneIdentifier2_SetAppZoneId(IZoneIdentifier2* This,DWORD zone) {
    return This->lpVtbl->SetAppZoneId(This,zone);
}
static FORCEINLINE HRESULT IZoneIdentifier2_RemoveAppZoneId(IZoneIdentifier2* This) {
    return This->lpVtbl->RemoveAppZoneId(This);
}
#endif
#endif
...
DEFINE_GUID(IID_IBindHttpSecurity, 0xa9eda967, 0xf50e, 0x4a33, 0xb3,0x58, 0x20,0x6f,0x6e,0xf3,0x08,0x6d);
#if defined(__cplusplus) && !defined(CINTERFACE)
...
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IBindHttpSecurity, 0xa9eda967, 0xf50e, 0x4a33, 0xb3,0x58, 0x20,0x6f,0x6e,0xf3,0x08,0x6d)
#endif
#else
...
#ifndef WIDL_C_INLINE_WRAPPERS
/*** IUnknown methods ***/
#define IBindHttpSecurity_QueryInterface(This,riid,ppvObject) (This)->lpVtbl->QueryInterface(This,riid,ppvObject)
#define IBindHttpSecurity_AddRef(This) (This)->lpVtbl->AddRef(This)
#define IBindHttpSecurity_Release(This) (This)->lpVtbl->Release(This)
/*** IBindHttpSecurity methods ***/
#define IBindHttpSecurity_GetIgnoreCertMask(This,pdwIgnoreCertMask) (This)->lpVtbl->GetIgnoreCertMask(This,pdwIgnoreCertMask)
#else
/*** IUnknown methods ***/
static FORCEINLINE HRESULT IBindHttpSecurity_QueryInterface(IBindHttpSecurity* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static FORCEINLINE ULONG IBindHttpSecurity_AddRef(IBindHttpSecurity* This) {
    return This->lpVtbl->AddRef(This);
}
static FORCEINLINE ULONG IBindHttpSecurity_Release(IBindHttpSecurity* This) {
    return This->lpVtbl->Release(This);
}
/*** IBindHttpSecurity methods ***/
static FORCEINLINE HRESULT IBindHttpSecurity_GetIgnoreCertMask(IBindHttpSecurity* This,DWORD *pdwIgnoreCertMask) {
    return This->lpVtbl->GetIgnoreCertMask(This,pdwIgnoreCertMask);
}
#endif
#endif
