/*** Autogenerated by WIDL 7.0-rc1 from ./bits.idl - Do not edit ***/
...
AsyncIBackgroundCopyCallback : public IUnknown
{
    ...
    virtual HRESULT STDMETHODCALLTYPE Finish_JobTransferred(
        ) = 0;
    ...
    virtual HRESULT STDMETHODCALLTYPE Finish_JobError(
        ) = 0;
    ...
    virtual HRESULT STDMETHODCALLTYPE Finish_JobModification(
        ) = 0;

};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(AsyncIBackgroundCopyCallback, 0xca29d251, 0xb4bb, 0x4679, 0xa3,0xd9, 0xae,0x80,0x06,0x11,0x9d,0x54)
#endif
#else
...
#else
/*** IUnknown methods ***/
static FORCEINLINE HRESULT AsyncIBackgroundCopyCallback_QueryInterface(AsyncIBackgroundCopyCallback* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static FORCEINLINE ULONG AsyncIBackgroundCopyCallback_AddRef(AsyncIBackgroundCopyCallback* This) {
    return This->lpVtbl->AddRef(This);
}
static FORCEINLINE ULONG AsyncIBackgroundCopyCallback_Release(AsyncIBackgroundCopyCallback* This) {
    return This->lpVtbl->Release(This);
}
/*** AsyncIBackgroundCopyCallback methods ***/
static FORCEINLINE HRESULT AsyncIBackgroundCopyCallback_Begin_JobTransferred(AsyncIBackgroundCopyCallback* This,IBackgroundCopyJob *pJob) {
    return This->lpVtbl->Begin_JobTransferred(This,pJob);
}
static FORCEINLINE HRESULT AsyncIBackgroundCopyCallback_Finish_JobTransferred(AsyncIBackgroundCopyCallback* This) {
    return This->lpVtbl->Finish_JobTransferred(This);
}
static FORCEINLINE HRESULT AsyncIBackgroundCopyCallback_Begin_JobError(AsyncIBackgroundCopyCallback* This,IBackgroundCopyJob *pJob,IBackgroundCopyError *pError) {
    return This->lpVtbl->Begin_JobError(This,pJob,pError);
}
static FORCEINLINE HRESULT AsyncIBackgroundCopyCallback_Finish_JobError(AsyncIBackgroundCopyCallback* This) {
    return This->lpVtbl->Finish_JobError(This);
}
static FORCEINLINE HRESULT AsyncIBackgroundCopyCallback_Begin_JobModification(AsyncIBackgroundCopyCallback* This,IBackgroundCopyJob *pJob,DWORD dwReserved) {
    return This->lpVtbl->Begin_JobModification(This,pJob,dwReserved);
}
static FORCEINLINE HRESULT AsyncIBackgroundCopyCallback_Finish_JobModification(AsyncIBackgroundCopyCallback* This) {
    return This->lpVtbl->Finish_JobModification(This);
}
#endif
#endif
