/*** Autogenerated by WIDL 7.0-rc1 from ./vss.idl - Do not edit ***/
...
#ifndef __IVssSnapshot_FWD_DEFINED__
#define __IVssSnapshot_FWD_DEFINED__
typedef interface IVssSnapshot IVssSnapshot;
#ifdef __cplusplus
