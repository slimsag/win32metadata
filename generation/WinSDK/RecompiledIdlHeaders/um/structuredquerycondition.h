/*** Autogenerated by WIDL 7.0-rc1 from ./structuredquerycondition.idl - Do not edit ***/
...
static FORCEINLINE HRESULT ICondition_Save(ICondition* This,IStream *pStm,BOOL fClearDirty) {
...
static FORCEINLINE HRESULT ICondition2_Save(ICondition2* This,IStream *pStm,BOOL fClearDirty) {
    return This->lpVtbl->Save(This,pStm,fClearDirty);
}
