/*** Autogenerated by WIDL 7.0-rc1 from ./oleidl.idl - Do not edit ***/
...
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IEnterpriseDropTarget, 0x390e3878, 0xfd55, 0x4e18, 0x81,0x9d, 0x46,0x82,0x08,0x1c,0x0c,0xfd)
#endif
#else
...
#else
/*** IUnknown methods ***/
static FORCEINLINE HRESULT IEnterpriseDropTarget_QueryInterface(IEnterpriseDropTarget* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static FORCEINLINE ULONG IEnterpriseDropTarget_AddRef(IEnterpriseDropTarget* This) {
    return This->lpVtbl->AddRef(This);
}
static FORCEINLINE ULONG IEnterpriseDropTarget_Release(IEnterpriseDropTarget* This) {
    return This->lpVtbl->Release(This);
}
/*** IEnterpriseDropTarget methods ***/
static FORCEINLINE HRESULT IEnterpriseDropTarget_SetDropSourceEnterpriseId(IEnterpriseDropTarget* This,LPCWSTR identity) {
    return This->lpVtbl->SetDropSourceEnterpriseId(This,identity);
}
static FORCEINLINE HRESULT IEnterpriseDropTarget_IsEvaluatingEdpPolicy(IEnterpriseDropTarget* This,BOOL *value) {
    return This->lpVtbl->IsEvaluatingEdpPolicy(This,value);
}
#endif
#endif
