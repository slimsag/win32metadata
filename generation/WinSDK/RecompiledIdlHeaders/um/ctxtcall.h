/*** Autogenerated by WIDL 7.0-rc1 from ./ctxtcall.idl - Do not edit ***/
...
/*** IContextCallback methods ***/
static FORCEINLINE HRESULT IContextCallback_ContextCallback(IContextCallback* This,PFNCONTEXTCALL pfnCallback,ComCallData *pParam,REFIID riid,int iMethod,IUnknown *pUnk) {
    return This->lpVtbl->ContextCallback(This,pfnCallback,pParam,riid,iMethod,pUnk);
}
#endif
#endif
