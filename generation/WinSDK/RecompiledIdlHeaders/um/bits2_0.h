/*** Autogenerated by WIDL 7.0-rc1 from ./bits2_0.idl - Do not edit ***/
...
/*** IBackgroundCopyJob2 methods ***/
static FORCEINLINE HRESULT IBackgroundCopyJob3_SetNotifyCmdLine(IBackgroundCopyJob3* This,LPCWSTR Program,LPCWSTR Parameters) {
    return This->lpVtbl->SetNotifyCmdLine(This,Program,Parameters);
}
static FORCEINLINE HRESULT IBackgroundCopyJob3_GetNotifyCmdLine(IBackgroundCopyJob3* This,LPWSTR *pProgram,LPWSTR *pParameters) {
    return This->lpVtbl->GetNotifyCmdLine(This,pProgram,pParameters);
}
static FORCEINLINE HRESULT IBackgroundCopyJob3_GetReplyProgress(IBackgroundCopyJob3* This,BG_JOB_REPLY_PROGRESS *pProgress) {
    return This->lpVtbl->GetReplyProgress(This,pProgress);
}
static FORCEINLINE HRESULT IBackgroundCopyJob3_GetReplyData(IBackgroundCopyJob3* This,byte **ppBuffer,UINT64 *pLength) {
    return This->lpVtbl->GetReplyData(This,ppBuffer,pLength);
}
static FORCEINLINE HRESULT IBackgroundCopyJob3_SetReplyFileName(IBackgroundCopyJob3* This,LPCWSTR ReplyFileName) {
    return This->lpVtbl->SetReplyFileName(This,ReplyFileName);
}
static FORCEINLINE HRESULT IBackgroundCopyJob3_GetReplyFileName(IBackgroundCopyJob3* This,LPWSTR *pReplyFileName) {
    return This->lpVtbl->GetReplyFileName(This,pReplyFileName);
}
static FORCEINLINE HRESULT IBackgroundCopyJob3_SetCredentials(IBackgroundCopyJob3* This,BG_AUTH_CREDENTIALS *credentials) {
