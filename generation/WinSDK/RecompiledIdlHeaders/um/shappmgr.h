/*** Autogenerated by WIDL 7.0-rc1 from ./shappmgr.idl - Do not edit ***/
...
__CRT_UUID_DECL(IShellApp, 0xa3e14960, 0x935f, 0x11d1, 0xb8,0xb8, 0x00,0x60,0x08,0x05,0x93,0x82)
#endif
#else
...
#else
/*** IUnknown methods ***/
static FORCEINLINE HRESULT IShellApp_QueryInterface(IShellApp* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static FORCEINLINE ULONG IShellApp_AddRef(IShellApp* This) {
    return This->lpVtbl->AddRef(This);
}
static FORCEINLINE ULONG IShellApp_Release(IShellApp* This) {
    return This->lpVtbl->Release(This);
}
/*** IShellApp methods ***/
static FORCEINLINE HRESULT IShellApp_GetAppInfo(IShellApp* This,PAPPINFODATA pai) {
    return This->lpVtbl->GetAppInfo(This,pai);
}
static FORCEINLINE HRESULT IShellApp_GetPossibleActions(IShellApp* This,DWORD *pdwActions) {
    return This->lpVtbl->GetPossibleActions(This,pdwActions);
}
static FORCEINLINE HRESULT IShellApp_GetSlowAppInfo(IShellApp* This,PSLOWAPPINFO psaid) {
    return This->lpVtbl->GetSlowAppInfo(This,psaid);
}
static FORCEINLINE HRESULT IShellApp_GetCachedSlowAppInfo(IShellApp* This,PSLOWAPPINFO psaid) {
    return This->lpVtbl->GetCachedSlowAppInfo(This,psaid);
}
static FORCEINLINE HRESULT IShellApp_IsInstalled(IShellApp* This) {
    return This->lpVtbl->IsInstalled(This);
}
#endif
#endif
...
DEFINE_GUID(IID_IPublishedApp, 0x1bc752e0, 0x9046, 0x11d1, 0xb8,0xb3, 0x00,0x60,0x08,0x05,0x93,0x82);
#if defined(__cplusplus) && !defined(CINTERFACE)
MIDL_INTERFACE("1bc752e0-9046-11d1-b8b3-006008059382")
IPublishedApp : public IShellApp
{
    virtual HRESULT STDMETHODCALLTYPE Install(
        LPSYSTEMTIME pstInstall) = 0;

    virtual HRESULT STDMETHODCALLTYPE GetPublishedAppInfo(
        PPUBAPPINFO ppai) = 0;

    virtual HRESULT STDMETHODCALLTYPE Unschedule(
        ) = 0;

};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IPublishedApp, 0x1bc752e0, 0x9046, 0x11d1, 0xb8,0xb3, 0x00,0x60,0x08,0x05,0x93,0x82)
#endif
#else
...
#else
/*** IUnknown methods ***/
static FORCEINLINE HRESULT IPublishedApp_QueryInterface(IPublishedApp* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static FORCEINLINE ULONG IPublishedApp_AddRef(IPublishedApp* This) {
    return This->lpVtbl->AddRef(This);
}
static FORCEINLINE ULONG IPublishedApp_Release(IPublishedApp* This) {
    return This->lpVtbl->Release(This);
}
/*** IShellApp methods ***/
static FORCEINLINE HRESULT IPublishedApp_GetAppInfo(IPublishedApp* This,PAPPINFODATA pai) {
    return This->lpVtbl->GetAppInfo(This,pai);
}
static FORCEINLINE HRESULT IPublishedApp_GetPossibleActions(IPublishedApp* This,DWORD *pdwActions) {
    return This->lpVtbl->GetPossibleActions(This,pdwActions);
}
static FORCEINLINE HRESULT IPublishedApp_GetSlowAppInfo(IPublishedApp* This,PSLOWAPPINFO psaid) {
    return This->lpVtbl->GetSlowAppInfo(This,psaid);
}
static FORCEINLINE HRESULT IPublishedApp_GetCachedSlowAppInfo(IPublishedApp* This,PSLOWAPPINFO psaid) {
    return This->lpVtbl->GetCachedSlowAppInfo(This,psaid);
}
static FORCEINLINE HRESULT IPublishedApp_IsInstalled(IPublishedApp* This) {
    return This->lpVtbl->IsInstalled(This);
}
/*** IPublishedApp methods ***/
static FORCEINLINE HRESULT IPublishedApp_Install(IPublishedApp* This,LPSYSTEMTIME pstInstall) {
    return This->lpVtbl->Install(This,pstInstall);
}
static FORCEINLINE HRESULT IPublishedApp_GetPublishedAppInfo(IPublishedApp* This,PPUBAPPINFO ppai) {
    return This->lpVtbl->GetPublishedAppInfo(This,ppai);
}
static FORCEINLINE HRESULT IPublishedApp_Unschedule(IPublishedApp* This) {
    return This->lpVtbl->Unschedule(This);
}
#endif
#endif
...
DEFINE_GUID(IID_IPublishedApp2, 0x12b81347, 0x1b3a, 0x4a04, 0xaa,0x61, 0x3f,0x76,0x8b,0x67,0xfd,0x7e);
#if defined(__cplusplus) && !defined(CINTERFACE)
...
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IPublishedApp2, 0x12b81347, 0x1b3a, 0x4a04, 0xaa,0x61, 0x3f,0x76,0x8b,0x67,0xfd,0x7e)
#endif
#else
...
#else
/*** IUnknown methods ***/
static FORCEINLINE HRESULT IPublishedApp2_QueryInterface(IPublishedApp2* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static FORCEINLINE ULONG IPublishedApp2_AddRef(IPublishedApp2* This) {
    return This->lpVtbl->AddRef(This);
}
static FORCEINLINE ULONG IPublishedApp2_Release(IPublishedApp2* This) {
    return This->lpVtbl->Release(This);
}
/*** IShellApp methods ***/
static FORCEINLINE HRESULT IPublishedApp2_GetAppInfo(IPublishedApp2* This,PAPPINFODATA pai) {
    return This->lpVtbl->GetAppInfo(This,pai);
}
static FORCEINLINE HRESULT IPublishedApp2_GetPossibleActions(IPublishedApp2* This,DWORD *pdwActions) {
    return This->lpVtbl->GetPossibleActions(This,pdwActions);
}
static FORCEINLINE HRESULT IPublishedApp2_GetSlowAppInfo(IPublishedApp2* This,PSLOWAPPINFO psaid) {
    return This->lpVtbl->GetSlowAppInfo(This,psaid);
}
static FORCEINLINE HRESULT IPublishedApp2_GetCachedSlowAppInfo(IPublishedApp2* This,PSLOWAPPINFO psaid) {
    return This->lpVtbl->GetCachedSlowAppInfo(This,psaid);
}
static FORCEINLINE HRESULT IPublishedApp2_IsInstalled(IPublishedApp2* This) {
    return This->lpVtbl->IsInstalled(This);
}
/*** IPublishedApp methods ***/
static FORCEINLINE HRESULT IPublishedApp2_Install(IPublishedApp2* This,LPSYSTEMTIME pstInstall) {
    return This->lpVtbl->Install(This,pstInstall);
}
static FORCEINLINE HRESULT IPublishedApp2_GetPublishedAppInfo(IPublishedApp2* This,PPUBAPPINFO ppai) {
    return This->lpVtbl->GetPublishedAppInfo(This,ppai);
}
static FORCEINLINE HRESULT IPublishedApp2_Unschedule(IPublishedApp2* This) {
    return This->lpVtbl->Unschedule(This);
}
/*** IPublishedApp2 methods ***/
static FORCEINLINE HRESULT IPublishedApp2_Install2(IPublishedApp2* This,LPSYSTEMTIME pstInstall,HWND hwndParent) {
    return This->lpVtbl->Install2(This,pstInstall,hwndParent);
}
#endif
#endif
...
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IEnumPublishedApps, 0x0b124f8c, 0x91f0, 0x11d1, 0xb8,0xb5, 0x00,0x60,0x08,0x05,0x93,0x82)
#endif
#else
...
#else
/*** IUnknown methods ***/
static FORCEINLINE HRESULT IEnumPublishedApps_QueryInterface(IEnumPublishedApps* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static FORCEINLINE ULONG IEnumPublishedApps_AddRef(IEnumPublishedApps* This) {
    return This->lpVtbl->AddRef(This);
}
static FORCEINLINE ULONG IEnumPublishedApps_Release(IEnumPublishedApps* This) {
    return This->lpVtbl->Release(This);
}
/*** IEnumPublishedApps methods ***/
static FORCEINLINE HRESULT IEnumPublishedApps_Next(IEnumPublishedApps* This,IPublishedApp **pia) {
    return This->lpVtbl->Next(This,pia);
}
static FORCEINLINE HRESULT IEnumPublishedApps_Reset(IEnumPublishedApps* This) {
...
DEFINE_GUID(IID_IAppPublisher, 0x07250a10, 0x9cf9, 0x11d1, 0x90,0x76, 0x00,0x60,0x08,0x05,0x93,0x82);
#if defined(__cplusplus) && !defined(CINTERFACE)
...
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IAppPublisher, 0x07250a10, 0x9cf9, 0x11d1, 0x90,0x76, 0x00,0x60,0x08,0x05,0x93,0x82)
#endif
#else
...
#else
/*** IUnknown methods ***/
static FORCEINLINE HRESULT IAppPublisher_QueryInterface(IAppPublisher* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static FORCEINLINE ULONG IAppPublisher_AddRef(IAppPublisher* This) {
    return This->lpVtbl->AddRef(This);
}
static FORCEINLINE ULONG IAppPublisher_Release(IAppPublisher* This) {
    return This->lpVtbl->Release(This);
}
/*** IAppPublisher methods ***/
static FORCEINLINE HRESULT IAppPublisher_GetNumberOfCategories(IAppPublisher* This,DWORD *pdwCat) {
    return This->lpVtbl->GetNumberOfCategories(This,pdwCat);
}
static FORCEINLINE HRESULT IAppPublisher_GetCategories(IAppPublisher* This,APPCATEGORYINFOLIST *pAppCategoryList) {
    return This->lpVtbl->GetCategories(This,pAppCategoryList);
}
static FORCEINLINE HRESULT IAppPublisher_GetNumberOfApps(IAppPublisher* This,DWORD *pdwApps) {
    return This->lpVtbl->GetNumberOfApps(This,pdwApps);
}
static FORCEINLINE HRESULT IAppPublisher_EnumApps(IAppPublisher* This,GUID *pAppCategoryId,IEnumPublishedApps **ppepa) {
    return This->lpVtbl->EnumApps(This,pAppCategoryId,ppepa);
}
#endif
#endif
