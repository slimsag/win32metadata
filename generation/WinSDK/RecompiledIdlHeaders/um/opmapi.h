/*** Autogenerated by WIDL 7.0-rc1 from ./opmapi.idl - Do not edit ***/
...
IOPMVideoOutput : public IUnknown
{
    virtual HRESULT STDMETHODCALLTYPE StartInitialization(
        ...
        BYTE **ppbCertificate,
        ULONG *pulCertificateLength) = 0;

    virtual HRESULT STDMETHODCALLTYPE FinishInitialization(
        const OPM_ENCRYPTED_INITIALIZATION_PARAMETERS *pParameters) = 0;

    virtual HRESULT STDMETHODCALLTYPE GetInformation(
        const OPM_GET_INFO_PARAMETERS *pParameters,
        OPM_REQUESTED_INFORMATION *pRequestedInformation) = 0;
    ...
    virtual HRESULT STDMETHODCALLTYPE Configure(
        ...
        const BYTE *pbAdditionalParameters) = 0;

};
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IOPMVideoOutput, 0x0a15159d, 0x41c7, 0x4456, 0x93,0xe1, 0x28,0x4c,0xd6,0x1d,0x4e,0x8d)
#endif
#else
...
interface IOPMVideoOutput {
    CONST_VTBL IOPMVideoOutputVtbl* lpVtbl;
};
...
#else
/*** IUnknown methods ***/
static FORCEINLINE HRESULT IOPMVideoOutput_QueryInterface(IOPMVideoOutput* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static FORCEINLINE ULONG IOPMVideoOutput_AddRef(IOPMVideoOutput* This) {
    return This->lpVtbl->AddRef(This);
}
static FORCEINLINE ULONG IOPMVideoOutput_Release(IOPMVideoOutput* This) {
    return This->lpVtbl->Release(This);
}
/*** IOPMVideoOutput methods ***/
static FORCEINLINE HRESULT IOPMVideoOutput_StartInitialization(IOPMVideoOutput* This,OPM_RANDOM_NUMBER *prnRandomNumber,BYTE **ppbCertificate,ULONG *pulCertificateLength) {
    return This->lpVtbl->StartInitialization(This,prnRandomNumber,ppbCertificate,pulCertificateLength);
}
static FORCEINLINE HRESULT IOPMVideoOutput_FinishInitialization(IOPMVideoOutput* This,const OPM_ENCRYPTED_INITIALIZATION_PARAMETERS *pParameters) {
    return This->lpVtbl->FinishInitialization(This,pParameters);
}
static FORCEINLINE HRESULT IOPMVideoOutput_GetInformation(IOPMVideoOutput* This,const OPM_GET_INFO_PARAMETERS *pParameters,OPM_REQUESTED_INFORMATION *pRequestedInformation) {
    return This->lpVtbl->GetInformation(This,pParameters,pRequestedInformation);
}
static FORCEINLINE HRESULT IOPMVideoOutput_COPPCompatibleGetInformation(IOPMVideoOutput* This,const OPM_COPP_COMPATIBLE_GET_INFO_PARAMETERS *pParameters,OPM_REQUESTED_INFORMATION *pRequestedInformation) {
    return This->lpVtbl->COPPCompatibleGetInformation(This,pParameters,pRequestedInformation);
}
static FORCEINLINE HRESULT IOPMVideoOutput_Configure(IOPMVideoOutput* This,const OPM_CONFIGURE_PARAMETERS *pParameters,ULONG ulAdditionalParametersSize,const BYTE *pbAdditionalParameters) {
    return This->lpVtbl->Configure(This,pParameters,ulAdditionalParametersSize,pbAdditionalParameters);
}
#endif
#endif
