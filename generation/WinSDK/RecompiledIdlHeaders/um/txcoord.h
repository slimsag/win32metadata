/*** Autogenerated by WIDL 7.0-rc1 from ./txcoord.idl - Do not edit ***/
...
void __RPC_STUB ITransactionImportWhereabouts_RemoteGetWhereabouts_Stub(
    ...
    DWORD* pdwStubPhase);
HRESULT CALLBACK ITransactionImportWhereabouts_GetWhereabouts_Proxy(
    ITransactionImportWhereabouts* This,
    ULONG cbWhereabouts,
    byte *rgbWhereabouts,
    ULONG *pcbUsed);
HRESULT __RPC_STUB ITransactionImportWhereabouts_GetWhereabouts_Stub(
    ITransactionImportWhereabouts* This,
    ULONG *pcbUsed,
    ULONG cbWhereabouts,
    byte *rgbWhereabouts);
...
void __RPC_STUB ITransactionExport_RemoteGetTransactionCookie_Stub(
    ...
    PRPC_MESSAGE pRpcMessage,
    DWORD* pdwStubPhase);
HRESULT CALLBACK ITransactionExport_GetTransactionCookie_Proxy(
    ITransactionExport* This,
    IUnknown *punkTransaction,
    ULONG cbTransactionCookie,
    byte *rgbTransactionCookie,
    ULONG *pcbUsed);
HRESULT __RPC_STUB ITransactionExport_GetTransactionCookie_Stub(
    ITransactionExport* This,
    IUnknown *punkTransaction,
    ULONG *pcbUsed,
    ULONG cbTransactionCookie,
...
typedef struct ITipTransactionVtbl {
    ...
    HRESULT (STDMETHODCALLTYPE *Push)(
        ITipTransaction *This,
        char *i_pszRemoteTmUrl,
        LPSTR *o_ppszRemoteTxUrl);

    HRESULT (STDMETHODCALLTYPE *GetTransactionUrl)(
        ITipTransaction *This,
        LPSTR *o_ppszLocalTxUrl);
...
/*** ITipTransaction methods ***/
static FORCEINLINE HRESULT ITipTransaction_Push(ITipTransaction* This,char *i_pszRemoteTmUrl,LPSTR *o_ppszRemoteTxUrl) {
    return This->lpVtbl->Push(This,i_pszRemoteTmUrl,o_ppszRemoteTxUrl);
}
static FORCEINLINE HRESULT ITipTransaction_GetTransactionUrl(ITipTransaction* This,LPSTR *o_ppszLocalTxUrl) {
...
/*****************************************************************************
 * IDtcNetworkAccessConfig3 interface
 */
#ifndef __IDtcNetworkAccessConfig3_INTERFACE_DEFINED__
#define __IDtcNetworkAccessConfig3_INTERFACE_DEFINED__

DEFINE_GUID(IID_IDtcNetworkAccessConfig3, 0x76e4b4f3, 0x2ca5, 0x466b, 0x89,0xd5, 0xfd,0x21,0x8e,0xe7,0x5b,0x49);
#if defined(__cplusplus) && !defined(CINTERFACE)
...
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IDtcNetworkAccessConfig3, 0x76e4b4f3, 0x2ca5, 0x466b, 0x89,0xd5, 0xfd,0x21,0x8e,0xe7,0x5b,0x49)
#endif
#else
typedef struct IDtcNetworkAccessConfig3Vtbl {
    ...
    /*** IDtcNetworkAccessConfig3 methods ***/
...
interface IDtcNetworkAccessConfig3 {
    CONST_VTBL IDtcNetworkAccessConfig3Vtbl* lpVtbl;
};
...
#else
/*** IUnknown methods ***/
static FORCEINLINE HRESULT IDtcNetworkAccessConfig3_QueryInterface(IDtcNetworkAccessConfig3* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static FORCEINLINE ULONG IDtcNetworkAccessConfig3_AddRef(IDtcNetworkAccessConfig3* This) {
    return This->lpVtbl->AddRef(This);
}
static FORCEINLINE ULONG IDtcNetworkAccessConfig3_Release(IDtcNetworkAccessConfig3* This) {
    return This->lpVtbl->Release(This);
}
/*** IDtcNetworkAccessConfig methods ***/
static FORCEINLINE HRESULT IDtcNetworkAccessConfig3_GetAnyNetworkAccess(IDtcNetworkAccessConfig3* This,BOOL *pbAnyNetworkAccess) {
    return This->lpVtbl->GetAnyNetworkAccess(This,pbAnyNetworkAccess);
}
static FORCEINLINE HRESULT IDtcNetworkAccessConfig3_SetAnyNetworkAccess(IDtcNetworkAccessConfig3* This,BOOL bAnyNetworkAccess) {
    return This->lpVtbl->SetAnyNetworkAccess(This,bAnyNetworkAccess);
}
static FORCEINLINE HRESULT IDtcNetworkAccessConfig3_GetNetworkAdministrationAccess(IDtcNetworkAccessConfig3* This,BOOL *pbNetworkAdministrationAccess) {
    return This->lpVtbl->GetNetworkAdministrationAccess(This,pbNetworkAdministrationAccess);
}
static FORCEINLINE HRESULT IDtcNetworkAccessConfig3_SetNetworkAdministrationAccess(IDtcNetworkAccessConfig3* This,BOOL bNetworkAdministrationAccess) {
    return This->lpVtbl->SetNetworkAdministrationAccess(This,bNetworkAdministrationAccess);
}
static FORCEINLINE HRESULT IDtcNetworkAccessConfig3_GetNetworkTransactionAccess(IDtcNetworkAccessConfig3* This,BOOL *pbNetworkTransactionAccess) {
    return This->lpVtbl->GetNetworkTransactionAccess(This,pbNetworkTransactionAccess);
}
static FORCEINLINE HRESULT IDtcNetworkAccessConfig3_SetNetworkTransactionAccess(IDtcNetworkAccessConfig3* This,BOOL bNetworkTransactionAccess) {
    return This->lpVtbl->SetNetworkTransactionAccess(This,bNetworkTransactionAccess);
}
static FORCEINLINE HRESULT IDtcNetworkAccessConfig3_GetNetworkClientAccess(IDtcNetworkAccessConfig3* This,BOOL *pbNetworkClientAccess) {
    return This->lpVtbl->GetNetworkClientAccess(This,pbNetworkClientAccess);
}
static FORCEINLINE HRESULT IDtcNetworkAccessConfig3_SetNetworkClientAccess(IDtcNetworkAccessConfig3* This,BOOL bNetworkClientAccess) {
    return This->lpVtbl->SetNetworkClientAccess(This,bNetworkClientAccess);
}
static FORCEINLINE HRESULT IDtcNetworkAccessConfig3_GetNetworkTIPAccess(IDtcNetworkAccessConfig3* This,BOOL *pbNetworkTIPAccess) {
    return This->lpVtbl->GetNetworkTIPAccess(This,pbNetworkTIPAccess);
}
static FORCEINLINE HRESULT IDtcNetworkAccessConfig3_SetNetworkTIPAccess(IDtcNetworkAccessConfig3* This,BOOL bNetworkTIPAccess) {
    return This->lpVtbl->SetNetworkTIPAccess(This,bNetworkTIPAccess);
}
static FORCEINLINE HRESULT IDtcNetworkAccessConfig3_GetXAAccess(IDtcNetworkAccessConfig3* This,BOOL *pbXAAccess) {
    return This->lpVtbl->GetXAAccess(This,pbXAAccess);
}
static FORCEINLINE HRESULT IDtcNetworkAccessConfig3_SetXAAccess(IDtcNetworkAccessConfig3* This,BOOL bXAAccess) {
    return This->lpVtbl->SetXAAccess(This,bXAAccess);
}
static FORCEINLINE HRESULT IDtcNetworkAccessConfig3_RestartDtcService(IDtcNetworkAccessConfig3* This) {
    return This->lpVtbl->RestartDtcService(This);
}
/*** IDtcNetworkAccessConfig2 methods ***/
static FORCEINLINE HRESULT IDtcNetworkAccessConfig3_GetNetworkInboundAccess(IDtcNetworkAccessConfig3* This,BOOL *pbInbound) {
    return This->lpVtbl->GetNetworkInboundAccess(This,pbInbound);
}
static FORCEINLINE HRESULT IDtcNetworkAccessConfig3_GetNetworkOutboundAccess(IDtcNetworkAccessConfig3* This,BOOL *pbOutbound) {
    return This->lpVtbl->GetNetworkOutboundAccess(This,pbOutbound);
}
static FORCEINLINE HRESULT IDtcNetworkAccessConfig3_SetNetworkInboundAccess(IDtcNetworkAccessConfig3* This,BOOL bInbound) {
    return This->lpVtbl->SetNetworkInboundAccess(This,bInbound);
}
static FORCEINLINE HRESULT IDtcNetworkAccessConfig3_SetNetworkOutboundAccess(IDtcNetworkAccessConfig3* This,BOOL bOutbound) {
    return This->lpVtbl->SetNetworkOutboundAccess(This,bOutbound);
}
static FORCEINLINE HRESULT IDtcNetworkAccessConfig3_GetAuthenticationLevel(IDtcNetworkAccessConfig3* This,AUTHENTICATION_LEVEL *pAuthLevel) {
    return This->lpVtbl->GetAuthenticationLevel(This,pAuthLevel);
}
static FORCEINLINE HRESULT IDtcNetworkAccessConfig3_SetAuthenticationLevel(IDtcNetworkAccessConfig3* This,AUTHENTICATION_LEVEL AuthLevel) {
    return This->lpVtbl->SetAuthenticationLevel(This,AuthLevel);
}
/*** IDtcNetworkAccessConfig3 methods ***/
static FORCEINLINE HRESULT IDtcNetworkAccessConfig3_GetLUAccess(IDtcNetworkAccessConfig3* This,BOOL *pbLUAccess) {
    return This->lpVtbl->GetLUAccess(This,pbLUAccess);
}
static FORCEINLINE HRESULT IDtcNetworkAccessConfig3_SetLUAccess(IDtcNetworkAccessConfig3* This,BOOL bLUAccess) {
    return This->lpVtbl->SetLUAccess(This,bLUAccess);
}
#endif
#endif
