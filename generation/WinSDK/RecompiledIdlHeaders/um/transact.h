/*** Autogenerated by WIDL 7.0-rc1 from ./transact.idl - Do not edit ***/
...
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IKernelTransaction, 0x79427a2b, 0xf895, 0x40e0, 0xbe,0x79, 0xb5,0x7d,0xc8,0x2e,0xd2,0x31)
#endif
#else
...
#else
/*** IUnknown methods ***/
static FORCEINLINE HRESULT IKernelTransaction_QueryInterface(IKernelTransaction* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static FORCEINLINE ULONG IKernelTransaction_AddRef(IKernelTransaction* This) {
    return This->lpVtbl->AddRef(This);
}
static FORCEINLINE ULONG IKernelTransaction_Release(IKernelTransaction* This) {
    return This->lpVtbl->Release(This);
}
/*** IKernelTransaction methods ***/
static FORCEINLINE HRESULT IKernelTransaction_GetHandle(IKernelTransaction* This,HANDLE *pHandle) {
    return This->lpVtbl->GetHandle(This,pHandle);
}
#endif
#endif
