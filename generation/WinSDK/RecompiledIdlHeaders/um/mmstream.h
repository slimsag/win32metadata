/*** Autogenerated by WIDL 7.0-rc1 from ./mmstream.idl - Do not edit ***/
...
static FORCEINLINE HRESULT IStreamSample_Update(IStreamSample* This,DWORD dwFlags,HANDLE hEvent,PAPCFUNC pfnAPC,DWORD_PTR dwAPCData) {
